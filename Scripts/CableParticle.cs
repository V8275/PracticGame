...
public class CableParticle
{
	...
	public CableParticle(Vector3 newPosition) { _oldPosition = _position = newPosition; }
	...
	{
		if (IsBound())
			if (_boundRigid == null) UpdatePosition(_boundTo.position);
			else
	...
	public bool IsFree() { return (_boundTo == null); }
		
	public bool IsBound() { return (_boundTo != null); }
